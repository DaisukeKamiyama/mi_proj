	...
	try
	{
		...
		_AInfo("ClassTest: AText",NULL);
		{
			...
			//#1472
			{
				...
				//ëSÉ^ÉCÉvâ¸çsÉRÅ[ÉhÇä‹ÇﬁÉeÉLÉXÉgÇCRÇ÷ïœä∑
				AText	mixedText;
				mixedText.Add('1');
				...
				//CRÇ÷ê≥ÇµÇ≠ïœä∑Ç≥ÇÍÇΩÇ±Ç∆ÇämîF
				AText	crText;
				crText.Add('1');
				...
				//U+2029Ç÷ê≥ÇµÇ≠ïœä∑Ç≥ÇÍÇΩÇ±Ç∆ÇämîF
				AText	u2029Text;
				u2029Text.Add('1');
