	...
	AEHandlerRefConT	/* inRefCon */)
{
	...
	if (directObjToken.DescriptorType() == typeAEList) {
		...
		/*#1034 SInt32*/long			containerSize = 0;
	...
	if (outReply.descriptorType != typeNull) {
		...
		//Modified by daisuke for mi (http://www.mimikaki.net) 2014/8/24 from HERE
		err = ::AEPutParamPtr(&outReply, keyAEResult, /*#1034 typeLongInteger*/typeSInt32,
