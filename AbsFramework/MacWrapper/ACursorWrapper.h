...
const ACursorType	kCursorType_PointingHand = 8;
const ACursorType	kCursorType_IBeamForVertical = 9;//#558
...
class ACursorWrapper
{
  public:
	...
	static ACursorType	GetCurrentCursorType() { return sCurrentCursorType; }//#606
	static ACursorType	sCurrentCursorType;//#606
};
