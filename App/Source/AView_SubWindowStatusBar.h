...
*/
class AView_SubWindowStatusBar : public AView
{
	//コンストラクタ、デストラクタ
  public:
	AView_SubWindowStatusBar( const AWindowID inWindowID, const AControlID inID );
	virtual ~AView_SubWindowStatusBar();
  private:
	void					NVIDO_Init();
  ...
  private:
	...
	//Object Type
  private:
	AViewType				NVIDO_GetViewType() const { return kViewType_SubWindowStatusBar; }
};
