...
ABool	AView_Text::EVTDO_DoInlineInputOffsetToPos( const AIndex inOffset, ALocalPoint& outPos )
{
	ATextPoint	textPoint;
	if( mInlineInputNotFixedTextLen > 0 )
	{
	...
	imagePoint.y += GetLineHeightWithoutMargin(textPoint.y);//#450 GetLineHeightWithoutMargin();
